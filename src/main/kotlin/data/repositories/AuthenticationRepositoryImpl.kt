...
class AuthenticationRepositoryImpl(
    private val dataSource : DataSource, private val passwordEncryptor : PasswordEncryptor
    ...
    override fun deleteUser(userId : UUID) : Boolean {
        val userDto = dataSource.getAllUsers().find { it.id == userId } ?: throw UserNotFoundException()
